...
namespace QuanLyCuaHangMayTinh
{
    public partial class frmQuanlybanhang_Nhanvien : Form
    {
        ...
        {
            Function.Connect();
            label1.Text = "QUẢN LÝ BÁN HÀNG MÁY TÍNH";
            iconButton1.Text = "Bán hàng (POS)";
            btnBaocaohoadon_nhanvien.Text = "Báo cáo hóa đơn";
            lbXinchao.Text = "Xin chào, " + (string.IsNullOrWhiteSpace(StaticData.HoTen) ? StaticData.TenDangNhap : StaticData.HoTen);
            KhoiTaoMenuMoRong();
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            ShowFormInPanel(new frmPOS(), pnelQuanlybanhang);
