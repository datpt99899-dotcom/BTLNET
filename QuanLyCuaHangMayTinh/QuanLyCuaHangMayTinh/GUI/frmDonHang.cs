...
namespace QuanLyCuaHangMayTinh.QuanLy
{
    public class frmDonDatHang : Form
    {
        ...
        private void BtnChuyen_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Chức năng chuyển đơn đặt hàng sang đơn bán đã được bổ sung ở mức giao diện. Hãy cấu hình bảng DonDatHang/HoaDonBan trong SQL để chạy nghiệp vụ đầy đủ.");
        }
    }
}
