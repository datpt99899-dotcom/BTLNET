...
namespace QuanLyCuaHangMayTinh_Forms.Forms
{
    partial class frmSanPham
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblMaSanPham.AutoSize = true; this.lblMaSanPham.Font = new Font("Segoe UI", 10F); this.lblMaSanPham.Location = new Point(20, 35); this.lblMaSanPham.Text = "Mã sản phẩm";
            this.txtMaSanPham.Font = new Font("Segoe UI", 10F); this.txtMaSanPham.Location = new Point(145, 31); this.txtMaSanPham.Name = "txtMaSanPham"; this.txtMaSanPham.Size = new Size(292, 25);
            this.lblTenSanPham.AutoSize = true; this.lblTenSanPham.Font = new Font("Segoe UI", 10F); this.lblTenSanPham.Location = new Point(20, 72); this.lblTenSanPham.Text = "Tên sản phẩm";
            this.txtTenSanPham.Font = new Font("Segoe UI", 10F); this.txtTenSanPham.Location = new Point(145, 68); this.txtTenSanPham.Name = "txtTenSanPham"; this.txtTenSanPham.Size = new Size(292, 25);
            this.lblLoaiSanPham.AutoSize = true; this.lblLoaiSanPham.Font = new Font("Segoe UI", 10F); this.lblLoaiSanPham.Location = new Point(20, 109); this.lblLoaiSanPham.Text = "Loại sản phẩm";
            this.cboLoaiSanPham.DropDownStyle = ComboBoxStyle.DropDownList; this.cboLoaiSanPham.Font = new Font("Segoe UI", 10F); this.cboLoaiSanPham.Location = new Point(145, 105); this.cboLoaiSanPham.Name = "cboLoaiSanPham"; this.cboLoaiSanPham.Size = new Size(292, 25);
            this.lblThuongHieu.AutoSize = true; this.lblThuongHieu.Font = new Font("Segoe UI", 10F); this.lblThuongHieu.Location = new Point(20, 146); this.lblThuongHieu.Text = "Thương hiệu";
            this.cboThuongHieu.DropDownStyle = ComboBoxStyle.DropDownList; this.cboThuongHieu.Font = new Font("Segoe UI", 10F); this.cboThuongHieu.Location = new Point(145, 142); this.cboThuongHieu.Name = "cboThuongHieu"; this.cboThuongHieu.Size = new Size(292, 25);
            this.lblNhaCungCap.AutoSize = true; this.lblNhaCungCap.Font = new Font("Segoe UI", 10F); this.lblNhaCungCap.Location = new Point(20, 183); this.lblNhaCungCap.Text = "Nhà cung cấp";
            this.cboNhaCungCap.DropDownStyle = ComboBoxStyle.DropDownList; this.cboNhaCungCap.Font = new Font("Segoe UI", 10F); this.cboNhaCungCap.Location = new Point(145, 179); this.cboNhaCungCap.Name = "cboNhaCungCap"; this.cboNhaCungCap.Size = new Size(292, 25);
            this.lblGiaNhap.AutoSize = true; this.lblGiaNhap.Font = new Font("Segoe UI", 10F); this.lblGiaNhap.Location = new Point(20, 220); this.lblGiaNhap.Text = "Giá nhập";
            this.txtGiaNhap.Font = new Font("Segoe UI", 10F); this.txtGiaNhap.Location = new Point(145, 216); this.txtGiaNhap.Name = "txtGiaNhap"; this.txtGiaNhap.Size = new Size(130, 25);
            ...
            this.lblSoLuongTon.AutoSize = true; this.lblSoLuongTon.Font = new Font("Segoe UI", 10F); this.lblSoLuongTon.Location = new Point(20, 257); this.lblSoLuongTon.Text = "Số lượng tồn";
            this.txtSoLuongTon.Font = new Font("Segoe UI", 10F); this.txtSoLuongTon.Location = new Point(145, 253); this.txtSoLuongTon.Name = "txtSoLuongTon"; this.txtSoLuongTon.Size = new Size(130, 25);
            ...
            this.lblMoTa.AutoSize = true; this.lblMoTa.Font = new Font("Segoe UI", 10F); this.lblMoTa.Location = new Point(20, 296); this.lblMoTa.Text = "Mô tả";
            this.rtbMoTa.Font = new Font("Segoe UI", 10F); this.rtbMoTa.Location = new Point(145, 292); this.rtbMoTa.Name = "rtbMoTa"; this.rtbMoTa.Size = new Size(292, 120);
            this.lblHinhAnh.AutoSize = true; this.lblHinhAnh.Font = new Font("Segoe UI", 10F); this.lblHinhAnh.Location = new Point(20, 432); this.lblHinhAnh.Text = "Hình ảnh";
            this.picHinhAnh.BackColor = Color.White; this.picHinhAnh.BorderStyle = BorderStyle.FixedSingle; this.picHinhAnh.Location = new Point(145, 430); this.picHinhAnh.Name = "picHinhAnh"; this.picHinhAnh.Size = new Size(128, 86); this.picHinhAnh.SizeMode = PictureBoxSizeMode.Zoom;
