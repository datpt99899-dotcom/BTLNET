...
namespace QuanLyCuaHangMayTinh
{
    internal class Function
    {
        ...
        /// <summary>Tạo SqlConnection MỚI — dùng cho transaction tự quản (form code cũ).</summary>
        public static SqlConnection GetSqlConnection()
        {
            return new SqlConnection(GetConnectionString());
        }

        /// <summary>Thực thi non-query với parameter — trả về số dòng bị ảnh hưởng.</summary>
        ...
        public static int RunSqlScalar(string sql, params SqlParameter[] parameters)
        {
            Connect();
            using (SqlCommand cmd = new SqlCommand(sql, Conn))
            {
