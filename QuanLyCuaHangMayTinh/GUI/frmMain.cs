...
namespace QuanLyCuaHangMayTinh
{
    ...
    public partial class frm_quanly : Form
    {
        ...
        {
            // Đề: Admin CRUD danh mục TRỪ SanPham → Admin xem SP read-only
            switch (StaticData.MaVaiTro)
            {
                case "VT02": return "Nhân viên kho";      // CRUD
                case "VT03": return "Nhân viên bán hàng"; // read
                default: return "Kế toán";                // Admin & Kế toán → read-only
            }
        }
