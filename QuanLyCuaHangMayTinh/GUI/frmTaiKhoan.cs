    ...
    public partial class frm_quanlytaikhoan : Form
    {
        ...
        private void frm_quanlytaikhoan_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Ẩn các control thừa từ template cũ
                if (txtLuong != null) txtLuong.Visible = false;
                if (mskNgaysinh != null) mskNgaysinh.Visible = false;
                if (label3 != null) label3.Text = "Vai trò";
                if (label12 != null) label12.Visible = false;
        ...
        {
            _dt = _bus.GetAll();
            if (datagridtaikhoan != null) datagridtaikhoan.DataSource = _dt;
        }
