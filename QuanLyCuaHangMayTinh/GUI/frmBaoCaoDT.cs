    ...
    public partial class frmBaoCaoDT : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                // Tổng chi phí = tổng tiền phiếu nhập kho trong khoảng
                try
                {
                    decimal tongCP = _bus.DapperGetTongChiPhi(from, to);
                    if (lblChiPhi != null) lblChiPhi.Text = tongCP.ToString("N0") + " đ";
                }
                catch { if (lblChiPhi != null) lblChiPhi.Text = "0 đ"; }
